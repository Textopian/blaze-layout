# BlazeLayout (carlosalvidrez:blaze-layout) 

> This project is earlier known as **kadira:flow-layout**. This is an exact copy of it but with dependencies modified for compatibility with newer versions of Meteor (3.1.0 tested).
> 
